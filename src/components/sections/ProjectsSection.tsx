      ...
      {featured.length > 0 && (
        <div className="space-y-8 mb-12">
          {featured.map((project) => (
            <div
              key={project.id}
              className="group relative bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-[#2F80ED]/40 transition-all duration-300"
            >
      ...
      {rest.length > 0 && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {rest.map((project) => (
            <div
              key={project.id}
              className="group bg-white/5 border border-white/10 rounded-xl overflow-hidden hover:border-[#2F80ED]/40 transition-all duration-300 flex flex-col"
            >
              {project.imageUrl && (
